...
public class AgendamentoService {
    ...
    public Agendamento createAgendamento(Authentication authentication, Long servicoId, Long prestadorId, LocalDate data, LocalTime hora){
        Cliente cliente = clienteService.findAuthenticaded(authentication);
